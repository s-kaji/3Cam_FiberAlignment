...
public partial class HDevelopExport1
{
    ...
    {
        loopstop = true;
        //MessageBox.Show("Press button to continue" + "\r\n" + "傾き = " + dip.ToString("0.0000"), "Program stop");
    }
    ...
    private void action()
    {
        ...
        try
        {
            ...
            HOperatorSet.OpenFramegrabber(hv_maker, 1, 1, 0, 0, 0, 0, "progressive", 8,
                "default", hv_number, "false", "default", hv_number, 0, -1, out hv_AcqHandle);
            ...
            while (!loopstop)
            {
                ...
                if (AlignmentEnable)
                {
                    ...
                    HOperatorSet.Rgb1ToGray(ho_ImageMirror, out ho_GrayImage);
                    //HOperatorSet.DispObj(ho_GrayImage, hv_ExpDefaultWinHandle);
                    ho_Edges.Dispose();
                    HOperatorSet.EdgesSubPix(ho_GrayImage, out ho_Edges, "canny", 15, 50, 100);
